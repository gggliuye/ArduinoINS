...
//
// This is a simple port of the code on the Geographic/UTM Coordinate Converter (1) page from
// Javascript to C++. Using this you can easily convert between UTM and WGS84 (latitude and
// longitude). Accuracy seems to be around 50cm (I suspect rounding errors are limiting precision).
...
// UTMXYToLatLon
// Converts x and y coordinates in the Universal Transverse Mercator//   The UTM zone parameter
// should be in the range [1,60].
